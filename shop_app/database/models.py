...
class UserProfile(Base):
    ...
    status : Mapped[StatusChoices] = mapped_column(String, Enum(StatusChoices), default=StatusChoices.simple)
...
class SubCategory(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True, autoincrement=True)
    subcategory_name : Mapped[str] = mapped_column(String(30), unique=True)
...
class Product(Base):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True, autoincrement=True)
    product_name: Mapped[str] = mapped_column(String(40), unique=True)
